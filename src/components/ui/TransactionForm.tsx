...
export function TransactionForm({
  onSubmit, onCancel, accounts, categories, costCenters, partners, initialValues,
  ...
  const handleSubmit = (values: FormValues) => {
    toast({ title: "Transaction saved", description: "Your transaction has been successfully saved." });
    onSubmit(values);
  };
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6 animate-scale-in">
        ...
        <FormField control={form.control} name="notes" render={({ field }) => (
          <FormItem>
            ...
            <FormControl><Textarea placeholder="Add any additional notes here" {...field} /></FormControl>
            <FormMessage />
          </FormItem>
        )} />
